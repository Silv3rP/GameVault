...
The search bar was updated to have a lightmode background image sourced from [vecteezy](https://www.vecteezy.com/photo/53857937-colorful-space-background-with-a-red-and-blue-swirl-the-colors-are-vibrant-and-the-swirls-are-dynamic).

The search bar was updated to have a darkmode background image sourced from [vecteezy](https://www.vecteezy.com/photo/11044489-panorama-milky-way-galaxy-with-stars-and-space-dust-in-the-universe).
